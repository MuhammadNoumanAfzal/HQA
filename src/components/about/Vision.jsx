...
export default function Vision() {
  ...
  // margin ensures it triggers slightly before fully visible
    ...
    >
      ...
      <div className="relative w-full max-w-6xl space-y-6">
        ...
        <motion.p
          ...
          initial="hidden"
          animate={isInView ? "visible" : "hidden"}
          className="mt-2 sm:mt-4 text-base sm:text-lg md:text-xl lg:text-2xl text-[#353535] italic"
        >
        ...
        <motion.p
          ...
          initial="hidden"
          animate={isInView ? "visible" : "hidden"}
          className="mt-4 text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed max-w-[850px] mx-auto px-2 sm:px-4"
        >
        ...
        <motion.p
          ...
          initial="hidden"
          animate={isInView ? "visible" : "hidden"}
          className="mt-4 text-sm sm:text-base md:text-lg lg:text-xl font-[Stika] leading-relaxed max-w-[900px] mx-auto px-2 sm:px-4"
        >
