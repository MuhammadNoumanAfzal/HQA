...
const Future = () => {
  return (
    <section className="bg-[#BCDDFC] min-h-[80vh] py-12 px-10 flex flex-col items-center justify-center text-center font-serif">
      ...
      {/* Description */}
      <p className="text-gray-800 max-w-4xl text-sm sm:text-base leading-relaxed">
      ...
      <p className="text-gray-800 max-w-4xl text-sm sm:text-base leading-relaxed mt-10">
