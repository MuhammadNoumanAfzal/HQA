              ...
              >
                <div className="relative w-full h-full flex flex-col md:flex-row items-center justify-center gap-4 md:gap-0">
                  ...
                  <div className="w-11/12  md:w-[45%] h-auto md:min-h-[50vh] flex relative md:-ml-12 z-30 -mt-12 md:mt-0">
                    <div className="bg-[#C8E1F8] text-white p-4 w-full flex flex-col overflow-y-auto shadow-lg">
                      <h3 className="text-xl sm:text-2xl italic mb-1 text-[#00285E]">
                        Step {pillar.id}
                      </h3>
                      <h3 className="text-xl sm:text-2xl italic mb-1 text-[#00285E]">
                        {pillar.title}
                      ...
                      <ul className="list-disc list-inside text-xs text-gray-800 sm:text-sm md:text-base mb-1 space-y-1">
