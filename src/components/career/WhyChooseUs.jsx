        ...
        <div className="grid grid-cols-1 lg:grid-cols-[35%_65%] gap-8 md:gap-12 items-center w-full">
          ...
          <div className="space-y-6">
            <motion.h2
              ...
              className="text-2xl sm:text-3xl md:text-6xl pt-12 text-gray-800 italic mb-4 mt-3"
            >
            ...
            {[
              ...
              >
                <div className="relative w-full h-full flex flex-col items-center justify-center">
                  ...
                  />
                  <div className="bg-[#00285EE5] pb-16 text-white p-3 md:p-6 rounded-xl -mt-16 sm:-mt-16 w-[95%] max-w-[420px]">
