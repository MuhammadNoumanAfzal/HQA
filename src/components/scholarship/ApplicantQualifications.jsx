...
const ApplicantQualifications = () => {
  return (
    <section className="w-full px-10 py-12 bg-[#fdfdfd] font-serif">
      ...
      {/* Intro Paragraph */}
      <p className="text-gray-800 text-1xl sm:text-2xl mb-4 max-w-4xl mx-auto text-left pl-2 sm:pl-4">
      ...
      <div className="overflow-x-auto flex justify-center mb-8">
        <table className="w-full max-w-3xl border border-gray-300 rounded-lg text-sm sm:text-base border-collapse table-fixed shadow-[12px_12px_20px_rgba(0,0,0,0.5)]">
          <thead>
