const Slogan = () => {
  return (
    <section className="flex justify-center items-center py-12 md:px-10 font-serif">
      ...
      <div className="relative w-full md:w-[96%] bg-white border border-gray-200 bg-cover bg-center py-6 flex flex-col items-center justify-center text-center rounded-lg shadow-[0_6px_20px_rgba(0,0,0,0.2)]">
        ...
        {/* Description */}
        <p className="text-gray-800 max-w-4xl text-xl leading-relaxed px-4 md:px-6 mb-4">
