  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-4xl flex flex-col items-center justify-center">
        ...
        {/* Description */}
        <p className="text-white text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed mb-4 px-2">
          We are committed to making Islamic education accessible. Need-based
          scholarships and sibling discounts are available.
        </p>
        <p className="text-white text-sm sm:text-base md:text-lg leading-relaxed mb-8 px-2">
          Visit our Tuition & Aid page for details.
        </p>

        {/* Button */}
        <button className="text-[#CF3528]  bg-white font-semibold px-6 sm:px-8 py-3  shadow-md transition-all duration-300 text-sm sm:text-base md:text-lg cursor-pointer">
          Tuition & Aid
        </button>
      </div>
    </section>
