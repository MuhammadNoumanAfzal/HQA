const Slogan = () => {
  return (
    <section
      className="relative bg-cover bg-center py-24  px-4 sm:px-10 flex items-center justify-center text-center font-serif"
    ...
    >
      ...
      <div className="relative w-full  flex flex-col items-center justify-center">
        ...
        {/* Description */}
        <p className="text-white max-w-3xl text-sm sm:text-base md:text-lg lg:text-xl leading-relaxed px-4 md:px-6 mb-4">
