  ...
  return (
    <section className="py-12 sm:py-16 bg-white text-gray-900 font-serif">
      <div className="px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <motion.h2
          className="text-3xl sm:text-4xl md:text-5xl text-center text-[#00285E] mb-4 sm:mb-6"
        ...
        <motion.p
          className="text-center text-gray-800 text-xl sm:text-base md:text-lg max-w-5xl mx-auto mb-8 sm:mb-12 leading-relaxed"
