...
const Welcome = () => {
  ...
  const titleText = "A Nurturing Start for a Lifetime of Successy";
  const subtitleText =
    "Montessori-Based Education for Ages 18 Months – 5 Years";
  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
        ...
        >
          At Houston Quran Academy, we don’t just teach—we nurture, inspire, and
          uplift. Our Pre-School program offers a powerful blend of the proven
          Montessori Method and the timeless values of Islam, creating a loving
          environment where your child grows with purpose—intellectually,
