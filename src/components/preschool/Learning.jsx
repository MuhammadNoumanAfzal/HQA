...
const Learning = () => {
  ...
  return (
    <section className="py-12 px-4 sm:px-6 md:px-10 font-serif bg-white">
      {/* Heading */}
      <h2 className="text-center text-3xl sm:text-4xl lg:text-5xl italic text-[#00285E] mb-4">
        Meet Our <span className="text-[#CF3528]">Lead Educators</span>
      </h2>

      {/* Centered Paragraph Below Heading */}
      <p className="text-center max-w-2xl mx-auto text-gray-700 text-sm sm:text-base md:text-lg mb-10">
        All lead teachers in the Pre-School program are AMS-certified,
        experienced in early childhood development, and deeply committed to the
        Islamic upbringing of your child.
      </p>
