...
const Welcome = () => {
  ...
  const titleText =
    "Preparing Students to Lead with Knowledge, Faith, and Confidence";
  const subtitleText =
    "Grades 6–8 | Academically Rigorous. Spiritually Grounded.";
  ...
  return (
    ...
    >
      ...
      <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
        ...
        >
          Grades 6–8 | Academically Rigorous. <br /> Spiritually Grounded.
        </motion.h3>
        ...
        >
          At Houston Quran Academy, our Middle School program bridges the
          foundation of elementary learning with the academic, social, and
          spiritual readiness needed for high school and beyond. Through a
          curriculum that meets Texas Essential Knowledge and Skills (TEKS) and
          National Standards, students are equipped with critical thinking
          skills, Islamic character, and a deep sense of purpose.
        </motion.p>
      </div>
