...
const Table3 = () => {
  return (
    <section className="w-full px-4 sm:px-6 md:px-10 py-12 bg-[#fdfdfd] font-serif">
      {/* Heading */}
      <h2 className="text-center text-3xl italic sm:text-4xl lg:text-5xl text-[#00285E] mb-8 ">
      ...
      <p className="text-center max-w-4xl mx-auto text-gray-800 text-xl  leading-relaxed">
        Children are placed according to their age as of September 1st of the
        enrolment year.
      </p>

      <p className="text-center max-w-3xl italic mx-auto text-gray-700 text-xl sm:text-2xl leading-relaxed pt-16">
