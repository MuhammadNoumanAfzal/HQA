          ...
          <div className="space-y-6">
            <div>
              ...
              <motion.p
                ...
                whileInView="visible"
                viewport={{ once: true, amount: 0.3 }}
                className="max-w-2xl text-xl leading-relaxed mb-6 sm:mb-8"
              >
            ...
            {[
              ...
              >
                <div className="relative w-full h-full flex flex-col items-center justify-center">
                  ...
                  />
                  <div className="bg-[#00285EE5] pb-16 text-white p-3 md:p-4 rounded-xl -mt-16 sm:-mt-16 w-[95%] max-w-[420px]">
