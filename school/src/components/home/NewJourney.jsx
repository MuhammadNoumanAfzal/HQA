  ...
  return (
    <section className="py-12 sm:py-16 bg-[#D8EDFF] text-gray-900 font-serif overflow-hidden overflow-x-hidden">
      <div className="px-4 sm:px-2 lg:px-8 text-center">
        ...
        {/* Subheading */}
        <motion.p
          className="max-w-3xl mx-auto text-gray-700 mb-8 sm:mb-10 text-sm sm:text-base md:text-lg leading-relaxed px-2 sm:px-0"
        ...
        <motion.div
          className="relative rounded-xl overflow-hidden shadow-md mb-8 sm:mb-10 w-full "
          initial={
            reduceMotion
              ? { opacity: 1, scale: 1 }
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <motion.button
              ...
              className="bg-white/70 rounded-full p-3 sm:p-5 cursor-pointer hover:bg-white/90 transition-all outline-none focus-visible:ring-4 focus-visible:ring-white/70"
        ...
        <motion.div
          ...
          viewport={{ once: true, amount: 0.3 }}
        >
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl font-medium text-[#0B49BD] text-center sm:text-left">
            Make a difference with your gift.
          </p>
          <motion.button
            type="button"
            className="bg-[#00285E] text-white px-5 sm:px-6 py-2 rounded-lg font-medium hover:bg-red-700 transition w-full sm:w-auto"
