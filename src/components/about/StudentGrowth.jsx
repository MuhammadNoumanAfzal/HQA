    ...
    <section className="bg-white py-12 md:py-18 lg:py-30 flex flex-col justify-center items-center text-center px-4 sm:px-6 md:px-10 font-serif overflow-hidden">
      <div className="w-full max-w-7xl mx-auto">
        ...
        <motion.p
          ...
          whileInView="visible"
          viewport={{ once: true, amount: 0.3 }}
          className="max-w-3xl mx-auto text-gray-800 text-xl leading-relaxed mb-12 px-2"
        >
        ...
        {/* Cards */}
        <motion.div
          className="grid grid-cols-2 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-2 justify-center md:px-20 cursor-pointer"
          variants={container}
          initial="hidden"
          whileInView="visible"
        ...
        >
          {stats.map((item, index) => (
            ...
            >
              ...
              <p
                className="text-gray-800 text-xs sm:text-sm md:text-base font-medium text-center leading-tight"
