...
const Learning = () => {
  ...
  return (
    <section className="py-12 px-4 sm:px-6 md:px-10 font-serif bg-[#CF3528]">
      {/* Heading */}
      <h2 className="text-center text-3xl sm:text-4xl lg:text-5xl italic text-white mb-8">
        Meet Our Lead Educators
      </h2>

      {/* Centered Paragraph Below Heading */}
      <p className="text-center max-w-4xl mx-auto text-white text-xl sm:text-base md:text-lg mb-10">
        Inspiring Educators. Faithful Role Models. Academic Champions
      </p>
      <p className="text-center max-w-4xl mx-auto text-white text-sm sm:text-base md:text-lg mb-10">
