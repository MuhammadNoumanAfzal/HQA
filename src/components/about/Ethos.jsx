...
const Ethos = () => {
  ...
  return (
    <section className="flex flex-col lg:flex-row font-serif items-center justify-between gap-6 py-14 px-10 relative">
      ...
      <div className="w-full lg:hidden flex flex-col items-center mb-4 md:mb-6">
        ...
        <motion.h3
          className="italic text-gray-800 text-xs sm:text-sm md:text-base text-center"
      ...
      <div className="w-full lg:w-[60%] relative">
        <AnimatePresence mode="wait">
          <motion.img
            ...
            alt="HQA Building"
            className="w-full h-56 sm:h-72 md:h-96 lg:h-[32rem] object-cover rounded-xl"
            variants={SlideUp(0)}
            initial="hidden"
            animate="visible"
            exit="hidden"
        ...
        {/* Card Overlay (Slider) - Fixed positioning */}
        {/* Card Overlay (Slider) - Mobile overlaps bottom */}
        <div
          className="absolute left-1/2 -translate-x-1/2 
    bottom-[-4rem] sm:bottom-[-1.5rem] md:bottom-4 
    bg-white shadow-lg rounded-lg p-4 sm:p-6 md:p-8 
    w-[90%] sm:w-[80%] md:w-[75%] lg:w-[70%] 
    lg:left-auto lg:translate-x-0 lg:bottom-4 lg:-right-120"
        >
          <AnimatePresence mode="wait">
            <motion.div
              ...
              exit="hidden"
            >
              <h4 className="text-[#CF3528] font-serif italic font-semibold mb-2 text-sm sm:text-base md:text-lg">
      ...
      <div className="w-full lg:w-[40%] flex-col  mb-90 items-start hidden lg:flex">
        ...
        <motion.h3
          className="italic text-gray-800 text-lg text-left"
          variants={SlideLeft(0.8)}
          initial="hidden"
          animate="visible"
        >
