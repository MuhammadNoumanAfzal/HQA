  ...
  return (
    <section className="flex flex-col items-center px-10 py-12 font-serif">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 w-full">
        {/* Left Image with Red Background Accent - Always first */}
        ...
        {/* Right Text Content - Always second */}
        <div className="w-full md:w-3/5 space-y-4 text-center md:text-left order-2">
          {/* Subheading */}
          <h3 className="text-2xl sm:text-3xl italic text-gray-800 text-left leading-relaxed">
            In Honor of Dedication to <br /> the Holy Quran
          </h3>

          {/* Description */}
          <p className="text-gray-800 leading-relaxed text-sm sm:text-base text-left">
