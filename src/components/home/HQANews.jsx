...
export default function HQANews() {
    ...
    News: [
      {
        ...
        image: "home/hqa1.jpg",
        title:
          "We are thrilled to announce the expansion of HQA with a new campus in Richmond!",
  ...
  return (
    <div className=" px-4 sm:px-6 lg:px-8 py-8 md:py-12 lg:py-16 font-serif">
      {/* Header */}
      <div className="text-center mb-8 md:mb-12 lg:mb-16">
        <motion.h2
          ...
          className="text-3xl sm:text-4xl md:text-5xl text-[#00285E]"
        >
