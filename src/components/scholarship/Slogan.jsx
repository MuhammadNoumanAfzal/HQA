const Slogan = () => {
  return (
    <section className="bg-[#BCDDFC] py-12 px-4 sm:px-8 md:px-12 flex flex-col items-center text-center font-serif">
      {/* Divider with logo */}
      ...
      <p className="text-gray-800 max-w-3xl text-sm sm:text-base md:text-lg leading-relaxed px-2">
        ...
        my peers. The school’s emphasis on public speaking and service shaped me
        into a proactive community member.”
      </p>
