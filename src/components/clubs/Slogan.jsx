const Slogan = () => {
  return (
    <section className="flex justify-center items-center py-12 md:px-10 font-serif">
      ...
      <div
        className="relative w-full md:w-[96%] border border-gray-200 bg-[#FFFFFF] bg-cover bg-center py-6 flex flex-col items-center justify-center text-center rounded-lg shadow-[0_0_12px_rgba(0,0,0,0.15)]
"
      >
