...
const WelcomeMsg = () => {
  ...
  const titleText = "Quran & Islamic Studies Club";
    ...
    >
      ...
      <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
        ...
        >
          ...
          <br />
          <br />
          Where young hearts grow in faith and minds thrive in Quranic wisdom.
        </motion.p>
        ...
        <motion.div
          ...
          animate={
            isInView
              ? {
                  opacity: textIndex >= titleLetters.length ? 1 : 0, // ✅ fixed
                  y: textIndex >= titleLetters.length ? 0 : 20,
                }
              : { opacity: 0, y: 20 }
          }
          ...
          className="pt-4"
        >
          <button className="flex items-center gap-2 text-white cursor-pointer bg-[#001d43] px-6 py-3 rounded-lg shadow-lg  hover:text-white transition duration-300 ">
            Student Life
          </button>
        </motion.div>
      </div>
