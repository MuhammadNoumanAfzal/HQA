    ...
    >
      ...
      <div className="w-full md:w-1/2 text-center md:text-left space-y-6">
        ...
        <motion.div
          ...
          className="pt-4"
        >
          <button className="flex items-center gap-2 bg-white text-red-700 px-6 py-3 rounded-lg shadow-lg hover:bg-[#001d43] hover:text-white transition duration-300 border-red-700 border-1">
