  ...
  return (
    <section className="w-full px-10 py-12 font-serif">
      ...
      <div className="mb-6 md:mb-10 lg:mb-12">
        <p className="border-l-4 md:border-l-[6px] border-[#CF3528] pl-3 md:pl-4  italic text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-[#00285E] leading-relaxed">
