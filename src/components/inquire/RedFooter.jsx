    ...
    <div className="bg-[#00285E]">
      <footer className=" bg-red-700  min-h-screen lg:mr-20 font-serif rounded-tr-[40px] lg:rounded-tr-[70px]">
          ...
          <div className="mt-12 lg:mt-24 space-y-5 lg:space-y-7 px-8 sm:px-12 lg:px-0 hidden lg:block">
            ...
            {["Employment", "Calendar", "Site Map", "Privacy Policy"].map(
              (item, i) => (
                <p
                  key={i}
                  className="text-white border-b text-lg lg:text-xl cursor-pointer hover:text-[#00285E] transition w-fit"
                >
                  {item}
                </p>
              )
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-6 lg:gap-0 mt-8 pb-4">
          ...
          <button className="h-12 w-40 lg:h-14 lg:w-44 bg-[#00285E] hover:text-red-700  hover:bg-white cursor-pointer text-lg lg:text-xl text-center text-white rounded-lg   lg:mr-20 transition ">
            Monefaction
          </button>
        </div>
      </footer>
